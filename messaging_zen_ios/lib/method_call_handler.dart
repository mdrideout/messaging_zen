...
Future<dynamic> methodCallHandler(MethodCall call) async {
  ...
  if (methodEnum == null) {
    throw ("Native platform call.method is not a valid InvokableMethodsEnum enum.");
  }
  ...
  switch (methodEnum) {
    ...
    default:
      logger.e("methodCallHandler has no matching case for the MethdCall from the native platform.");
      break;
  }
}
